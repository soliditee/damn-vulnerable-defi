...
describe("[Challenge] Side entrance", function () {
    ...
    it("Exploit", async function () {
        ...
        const SideEntranceSolverFactory = await ethers.getContractFactory("SideEntranceSolver", attacker)
        const solver = await SideEntranceSolverFactory.deploy()
        await solver.attack(this.pool.address)
